...
> **⚠️ 重要说明：本项目是基于原仓库的 Fork 版本，并进行了代码改造**

### 项目来源

本项目是从 [https://github.com/sansan0/TrendRadar](https://github.com/sansan0/TrendRadar) **Fork** 出来的，并在此基础上进行了代码改造和功能扩展。

**原仓库信息：**
- **原仓库地址**：https://github.com/sansan0/TrendRadar
- **原仓库作者**：sansan0
- **原仓库版本**：v3.4.0 (MCP v1.0.2)

### 代码改造说明

在保留原项目所有核心功能的基础上，本 Fork 版本进行了以下改造：

#### 🆕 新增功能模块

1. **`fetch_server/` - 新闻分析服务**
   - 独立的新闻分析服务模块
   - 负责新闻数据的获取、分析和处理
   - 模块化设计，便于维护和扩展

2. **`web_server/` - Web 服务器**
   - 基于 FastAPI 的 Web 服务
   - 采用 MVC（Model-View-Controller）三层架构
   - 提供 HTML 报告访问接口
   - 支持 RESTful API 访问

#### 🔄 架构改进

- **服务分离**：将原有功能拆分为独立服务，提高可维护性
- **模块化设计**：采用模块化架构，便于功能扩展
- **API 接口**：提供标准化的 API 接口，支持外部系统集成

#### ✅ 保留的原有功能

- ✅ 所有原项目的核心功能（热点聚合、智能推送、AI 分析等）
- ✅ 所有通知渠道支持（企业微信、飞书、钉钉、Telegram、邮件等）
- ✅ 所有配置选项和部署方式
- ✅ MCP 协议支持
...
**👉 [原仓库最新文档](https://github.com/sansan0/TrendRadar?tab=readme-ov-file)**
