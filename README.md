...
> **⚠️ Important Notice: This project is a Fork version based on the original repository, with code modifications**

### Project Source

This project is **Forked** from [https://github.com/sansan0/TrendRadar](https://github.com/sansan0/TrendRadar) and has been modified and extended with additional features.

**Original Repository Information:**
- **Original Repository URL**: https://github.com/sansan0/TrendRadar
- **Original Repository Author**: sansan0
- **Original Repository Version**: v3.4.0 (MCP v1.0.2)

### Code Modifications

While preserving all core features of the original project, this Fork version has made the following modifications:

#### 🆕 New Feature Modules

1. **`fetch_server/` - News Analysis Service**
   - Independent news analysis service module
   - Responsible for news data acquisition, analysis, and processing
   - Modular design for easy maintenance and extension

2. **`web_server/` - Web Server**
   - Web service based on FastAPI
   - Adopts MVC (Model-View-Controller) three-layer architecture
   - Provides HTML report access interface
   - Supports RESTful API access

#### 🔄 Architecture Improvements

- **Service Separation**: Split original functionality into independent services for better maintainability
- **Modular Design**: Adopts modular architecture for easy feature extension
- **API Interface**: Provides standardized API interfaces for external system integration

#### ✅ Preserved Original Features

- ✅ All core features of the original project (trending aggregation, smart push, AI analysis, etc.)
- ✅ All notification channel support (WeWork, Feishu, DingTalk, Telegram, Email, etc.)
- ✅ All configuration options and deployment methods
- ✅ MCP protocol support

### View Original Repository Latest Documentation

To view the latest updates and documentation from the original repository, please visit:

**👉 [Original Repository Latest Documentation](https://github.com/sansan0/TrendRadar?tab=readme-ov-file)**
